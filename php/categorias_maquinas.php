...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO categoria_maquina (nombre, descripcion) VALUES (?, ?)");
...
<head>
    ...
    <title>MINOVA - CATEGORIAS MAQUINAS</title>
...
<body>
    ...
    <template id="page-content">
        <div class="grid-contenedor-5">
            <div class="welcome">
                <div>
                    <h1>CATEGORIAS MAQUINAS</h1>
                    <p>Este es el formato de las categorias de las máquinas.</p>
            ...
            <div class="btn-container">
                <a href="../php/maquinas.php"><button class="btn-azul">
